...
export const EnumSchema: MessageFns<EnumSchema> = {
  ...
  create(base?: DeepPartial<EnumSchema>): EnumSchema {
    return EnumSchema.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<EnumSchema>): EnumSchema {
    const message = createBaseEnumSchema();
    message.description = object.description ?? "";
    message.default = object.default ?? "";
    message.title = object.title ?? "";
...
export const EnumSchema_ExtensionsEntry: MessageFns<EnumSchema_ExtensionsEntry> = {
  ...
  create(base?: DeepPartial<EnumSchema_ExtensionsEntry>): EnumSchema_ExtensionsEntry {
    return EnumSchema_ExtensionsEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<EnumSchema_ExtensionsEntry>): EnumSchema_ExtensionsEntry {
    const message = createBaseEnumSchema_ExtensionsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? undefined;
    return message;
...
function createBaseJSONSchema_FieldConfiguration(): JSONSchema_FieldConfiguration {
  return { pathParamName: "", deprecated: false };
}
